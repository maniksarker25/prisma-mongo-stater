...
const registrationSuccessEmailBody = (name, activationCode) => `
  <html>
    <head>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Thank you for registering with Protipzz. To activate your account, please use the following activation code:</p>
...
`;
exports.default = registrationSuccessEmailBody;
